...
Page({
  ...
  data: {
    ...
    cardList: [
      {
        ...
        url:
          "https://res.wx.qq.com/mmspraiweb_node/dist/static/pluginimage/chatIcon.png"
      },
      {
        title: "天气",
        content: "查询国内外主要城市的温度、风力、污染",
        url:
          "https://res.wx.qq.com/mmspraiweb_node/dist/static/pluginimage/weatherIcon.png"
      },
      {
        title: "百科",
        content: "北京今天天气如何 今天有雨吗",
        url:
          "https://res.wx.qq.com/mmspraiweb_node/dist/static/pluginimage/encyclopedias.png"
      },
      {
        title: "成语接龙",
        content: "陪你玩成语接龙游戏",
        url:
          "https://res.wx.qq.com/mmspraiweb_node/dist/static/pluginimage/idiom.png"
      }
    ],
    queryBMIList: [
      {
    ...
    background: [
      {
        bgUrl:
          "https://res.wx.qq.com/mmspraiweb_node/dist/static/pluginimage/bannerCard.png"
      },
      {
        bgUrl:
          "https://res.wx.qq.com/mmspraiweb_node/dist/static/pluginimage/iconTwo.png"
  ...
  onShareAppMessage: function() {
    ...
    return {
      ...
      imageUrl:
        "https://res.wx.qq.com/mmspraiweb_node/dist/static/openaiplugin/img/forward.png"
    };
  },
  // 四个模块
  goChat: function(e) {
    console.log(e);
    if (
      e.currentTarget.dataset.item.title === "聊天" ||
      e.currentTarget.dataset.item.title === "chat"
    ) {
      this.goChatCard(e);
      ...
      e.currentTarget.dataset.item.title === "百科" ||
  ...
  goWeatherCard: function(e) {
    ...
    if (
      this.data.weatherCardList.find(item => {
  ...
  goBMI: function(e) {
    if (
      this.data.queryBMIList.find(item => {
        if (item.title === e.currentTarget.dataset.item.title) {
          return true;
        }
      })
      ...
      if (
        e.currentTarget.dataset.item.title === "“算一下我的BMI体质指数是多少”"
      ) {
        title = "算一下我的BMI体质指数是多少";
      }
      if (
        e.currentTarget.dataset.item.title === "“我的身高175BMI体质指数是多少”"
      ) {
        title = "我的身高175BMI体质指数是多少";
      }
      this.jump(title);
  ...
  goGarbage: function(e) {
    if (
      this.data.garbageCardList.find(item => {
        if (item.title === e.currentTarget.dataset.item.title) {
          return true;
        }
      })
  ...
  goIdiom: function(e) {
    if (
      this.data.idiomGuideList.find(item => {
        if (item.title === e.currentTarget.dataset.item.title) {
          return true;
        }
      }) ||
