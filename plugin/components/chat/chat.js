           ...
           if (answer_type === 'music') {
              if (res.ans_node_name === '音乐') {
                newData = {
                  answer: '',
                  cardType: 'voice',
                  docs: JSON.parse(res.more_info.music_ans_detail).play_command.play_list
                }
                listData.push(newData)
                this.setData({
                  listData: listData,
                ...
                console.log(JSON.parse(res.more_info.fm_ans_detail).audio_play_command.play_list)
                newData = {
                  answer: '',
                  cardType: 'voice',
                  docs: JSON.parse(res.more_info.fm_ans_detail).audio_play_command.play_list
                }
                listData.push(newData)
                this.setData({
                  listData: listData,
              ...
              let more_news = JSON.parse(res.more_info.news_ans_detail).data.docs
              newData = {
                   ...
                   if (detail.length > 0) {
                     let tempList = detail
                      for (var i = 0; i < 6; i++) {
                        ...
                        tempList[i].dateTime = util.dateTimeFormat(slot_info.date)
